  ...
  return (
    <main className="flex flex-col gap-24 lg:gap-32">
      ...
      <section>
        ...
        <MasonryGrid data={testimonials} content={TestimonialCard} /></section>
