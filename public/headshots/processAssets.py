...
for file in queue:
    ...
    if resize > 0:
        ...
        img = img.resize((resize, int((resize / img.width) * img.height)),  Image.Resampling.LANCZOS, reducing_gap=2)# resize the img such that width is "resize" and height is scaled to keep aspect ratio
